...
emacs --batch --eval '(progn (require (quote package)) (package-activate-all) (package-quickstart-refresh) (byte-compile-file (locate-user-emacs-file "package-quickstart.el")))' 2>&1
